...
tif_list = [
   
    {
        ...
        'cbar_add_to_tick_value': 2000,
        'cbar_round_tick_value': 0,
        'cbar_side_title': 'secondary forest (2000)',
        'cbar_order': 4,
        'cbar_distance': 0.0,
    },
        {
...
tif_list = [
    ...
    {
        'path': '../../07_data_prepared/infrastructure/LAEA_new_build_up_area.tif',
        'colormap': 'Reds',
        'cmap_limits': (0.3, 0.9),
        'value_range': None,
        'single_color': '#f62afa',
...
output_path = 'results/maps/vegetation_oil_palm_00_03.png'
