...
minx, miny, maxx, maxy = [0 + x,  + y, 500000 + x, 500000 + y]
...
gdf.to_file("../../07_data_prepared/reduced_extent/boundary/borneo_boundary_large.shp")
...
gdf_boundary_small = gpd.read_file("../../07_data_prepared/reduced_extent/boundary/borneo_boundary_small.shp")
gdf_boundary_large = gpd.read_file("../../07_data_prepared/reduced_extent/boundary/borneo_boundary_large.shp")
```
...
# build up area
```{python}
clip_tif_to_bbox("../../07_data_prepared/infrastructure/utm_build_up_area.tif", gdf_boundary_large, "../../07_data_prepared/reduced_extent/infrastructure/utm_build_up_area_large.tif")
...
clip_tif_to_bbox("../../07_data_prepared/oil_palm/utm_oil_palm_2019_borneo.tif", gdf_boundary, "../../07_data_prepared/reduced_extent/oil_palm/test_utm_oil_palm_2019_borneo.tif")
clip_tif_to_bbox("../../07_data_prepared/oil_palm/utm_oil_palm_2019_borneo.tif", gdf_boundary, "test.tif")
```
