...
minx, miny, maxx, maxy = [0 + x,  + y, 1000 + x, 1000 + y]
...
gdf.to_file("../../07_data_prepared/reduced_extent/boundary/borneo_boundary_small.shp")
...
# build up area
```{python}
clip_tif_to_bbox("../../07_data_prepared/infrastructure/utm_build_up_area.tif", gdf_boundary_small, "../../07_data_prepared/reduced_extent/infrastructure/utm_build_up_area_small.tif")
